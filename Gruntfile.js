    ...
    var gruntConfig = {
        ...
        concat: {
            ...
            js: {
                ...
                dest: build_dir + '/javascripts/refinery/tinymce/tinymce.all.js'
            }
        },
        ...
        closureCompiler: {
            ...
            js: {
                ...
                dest: build_dir + '/javascripts/refinery/tinymce/tinymce.min.js'
            }
        },
        ...
        copy: {
            ...
            i18n: {
                files: [{
                    ...
                    dot: true,
                    cwd: 'i18n/',
                    dest: build_dir + '/javascripts/refinery/i18n/tinymce/',
                    src: [
                        '**'
                    ]
                }]
